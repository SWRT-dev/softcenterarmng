...
def work_parent():
    ignore_paths = frozenset(["maintain_files", "softcenter", "rules", "v2ray_binary", "transmission", "speedup", "speedtest", "ddnsto", "bxc", "uu", "dc1svr", "shadowsocks", "v2ray", "ssserver", "node"])
