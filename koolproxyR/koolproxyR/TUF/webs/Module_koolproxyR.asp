...
function refresh_acl_html() {
	...
	for (var field in acl_confs) {
		...
		code = code + '</td>';
		code = code + '<td>';
		code = code + '<select id="koolproxyR_acl_mode_' + ac["acl_node"] + '" name="koolproxyR_acl_mode_' + ac["acl_node"] + '" style="width:140px;margin:-1px 0px 0px 2px;" class="input_ss_table">';
	...
	code = code + '<td style="text-align: center;">缺省规则</td>';
	code = code + '<td>';
	code = code + '<select id="koolproxyR_acl_default" name="koolproxyR_acl_default" style="width:140px;margin:-1px 0px 0px 2px;" class="input_ss_table";">';
								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top" style="border-radius: 8px">
										...
										<div id="basic_settings" style="margin:10px 0px 0px 0px;width:748px">
											<table style="margin:-1px 0px 0px 0px;border: 1px solid #000000;width:100%;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable1" id="routing_table">
												...
												<tr id="policy_tr">
													<th>选择过滤模式</th>
													<td>
														<select name="koolproxyR_mode" id="koolproxyR_mode" class="input_ss_table" onchange="update_visibility(this);" style="width:auto;margin:0px 0px 0px 2px;">
												...
												<tr id="auto_reboot_switch">
													<th>〖规则〗自动更新</th>
													<td>
														<select name="koolproxyR_reboot" id="koolproxyR_reboot" class="input_ss_table" style="width:auto;margin:0px 0px 0px 2px;" onchange="update_visibility();">
														...
														<span id="koolproxyR_reboot_hour_span">
															&nbsp;&nbsp;&nbsp;&nbsp;
															每天
															<select id="koolproxyR_reboot_hour" name="koolproxyR_reboot_hour" class="input_ss_table" style="width:auto;margin:0px 0px 0px 2px;">																	
															...
															<select id="koolproxyR_reboot_min" name="koolproxyR_reboot_min" class="input_ss_table" style="width:auto;margin:0px 0px 0px 2px;">
														...
														<span id="koolproxyR_reboot_interval_span">
															&nbsp;&nbsp;&nbsp;&nbsp;
															每隔
														<select id="koolproxyR_reboot_inter_hour" name="koolproxyR_reboot_inter_hour" class="input_ss_table" style="width:auto;margin:0px 0px 0px 2px;">
																<option	value="1">1时</option>
																<option	value="2">2时</option>
																<option	value="3">3时</option>
																<option	value="4">4时</option>
														...
														<select id="koolproxyR_reboot_inter_min" name="koolproxyR_reboot_inter_min" class="input_ss_table" style="width:auto;margin:0px 0px 0px 2px;">
															    <option value="0">0分</option>
															</select>
															更新后重启koolproxyR
															&nbsp;&nbsp;&nbsp;&nbsp;
												...
												<tr id="acl_method_tr">
													<th>访问控制匹配方法</th>
													<td>
														<select name="koolproxyR_acl_method" id="koolproxyR_acl_method" class="input_ss_table" style="width:127px;margin:0px 0px 0px 2px;" onchange="update_visibility();">
										...
										<div id="ACL_table_div" style="margin:10px 0px 0px 0px;">
											<table id="ACL_table" style="margin:-1px 0px 0px 0px;border: 1px solid #000000;width:100%;" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable1" >
												<thead>
												<tr>
												...
												<tr>
													...
													<td>
														<select id="koolproxyR_acl_mode" name="koolproxyR_acl_mode" style="width:140px;margin:-1px 0px 0px 2px;" class="input_ss_table">
